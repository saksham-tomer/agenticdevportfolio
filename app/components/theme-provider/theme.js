...
// ── Void Purple Theme ──────────────────────────────────────────────────────────
// Replaced default teal (#84.42% 0.19 202.24) with electric violet-purple.
// Background deepens to near-black with a cool blue-black undertone.
const dark = {
  // Near-black with a cool blue-black undertone (not pure charcoal)
  background: 'oklch(10% 0.015 285)',
  backgroundLight: 'oklch(14% 0.02 285)',
  // Electric violet — the signature accent replacing teal
  primary: 'oklch(67% 0.28 292)',
  accent: 'oklch(67% 0.28 292)',
...
const light = {
  background: 'oklch(97% 0.005 285)',
  backgroundLight: 'var(--white)',
  primary: 'oklch(45% 0.24 292)',
  accent: 'oklch(55% 0.26 292)',
